...
// Vercel API support for mobile controller
...
$(document).ready(function() {
   ...
   // Initialize API connection for mobile controller
...
// Vercel API functions for mobile controller support
function initializeAPIConnection() {
   ...
   .then(data => {
      if (data.success) {
         isConnected = true;
         console.log('Game client registered with API:', data.message);
         
         // Set up polling to check for mobile commands
         startCommandPolling();
      } else {
         console.error('Failed to register game client:', data.message);
      }
   })
   .catch(error => {
      console.error('Error registering game client:', error);
   });
}
